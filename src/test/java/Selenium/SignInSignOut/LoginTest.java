...
public class LoginTest {
	...
	public static void main(String[] args) throws Exception
	{
		...
		driver.findElement(By.name("Username")).sendKeys("neha02177");
		
		driver.findElement(By.name("Passwd")).sendKeys("Neha@1234");
		
		Thread.sleep(2000);
		
		driver.findElement(By.name("ConfirmPasswd")).sendKeys("Neha@1234");
